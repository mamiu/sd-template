...
> This file was auto-generated with the \`init-sensitive-dotfiles.sh\` script from the [mamiu/sd-template](https://github.com/mamiu/sd-template) repository on $( date +'%F %H:%M' ).  
